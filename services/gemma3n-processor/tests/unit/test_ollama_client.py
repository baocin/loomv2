...
class TestOllamaClient:
    ...
    async def test_make_request_success(self, mock_client_class, ollama_client, mock_httpx_client):
    ...
    @patch('app.ollama_client.httpx.AsyncClient')
    async def test_health_check_success(self, mock_client_class, ollama_client, mock_httpx_client):
        ...
        mock_httpx_client.get.assert_called_once_with(f"{settings.ollama_host}/api/tags")
    ...
    async def test_analyze_image(self, mock_prepare, mock_request, ollama_client, sample_image_base64):
        """Test image analysis."""
    ...
    @patch('app.ollama_client.OllamaClient._make_request')
    @patch('app.ollama_client.OllamaClient._prepare_image')
    async def test_process_multimodal(self, mock_prepare, mock_request, ollama_client, sample_image_base64):
