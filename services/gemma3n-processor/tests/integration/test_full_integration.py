...
class TestFullIntegration:
    ...
    async def test_ollama_client_full_workflow(self, mock_client_class):
        ...
        def mock_json_response(*args, **kwargs):
            url = mock_client.post.call_args[1]['json'] if mock_client.post.call_args else {}
    ...
    async def test_kafka_consumer_full_workflow(self, mock_producer_class, mock_consumer_class):
    ...
    async def test_multimodal_request_processing(self, sample_image_data, sample_audio_data):
    ...
    async def test_concurrent_processing(self):
        ...
        tasks = [
            consumer_manager.process_text_message(msg) 
            for msg in messages
        ]
    ...
    async def test_message_validation_and_error_handling(self):
        ...
        invalid_messages = [
            ...
            {"device_id": "test", "recorded_at": "2024-06-27T12:00:00Z"},  # Missing text
        ]
