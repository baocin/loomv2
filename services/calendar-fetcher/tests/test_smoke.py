...
class TestCalendarFetcherSmoke:
    ...
    def test_fetch_events_empty_calendar(self, mock_calendar_fetcher, mock_kafka_producer):
    ...
    def test_fetch_events_error_handling(self, mock_calendar_fetcher, mock_kafka_producer):
        """Test error handling during calendar fetch."""
        from app.main import fetch_events
        
        # Make fetch_all_events raise an exception
        mock_calendar_fetcher.fetch_all_events.side_effect = Exception("CalDAV connection failed")
    ...
    def test_message_structure_compliance(self, mock_calendar_fetcher, mock_kafka_producer, sample_calendar_event):
    ...
    def test_recurring_events_handling(self, mock_calendar_fetcher, mock_kafka_producer):
    ...
    def test_multiple_calendars_handling(self, mock_calendar_fetcher, mock_kafka_producer):
