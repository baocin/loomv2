...
from .consumer import MotionDetectionConsumer

# Global consumer instance
consumer: Optional[MotionDetectionConsumer] = None
...
app = FastAPI(
    title="Significant Motion Detector",
    description="Detects significant motion events from accelerometer data",
    version="1.0.0",
    lifespan=lifespan
)
