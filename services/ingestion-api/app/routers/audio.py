        ...
        while True:
            ...
            try:
                ...
                if ws_message.message_type == "audio_chunk":
                    ...
                    if "chunk_data" in audio_data and isinstance(audio_data["chunk_data"], str):
                        import base64
                        audio_data["chunk_data"] = base64.b64decode(audio_data["chunk_data"])
                    ...
                    await connection_manager.send_message(device_id, {
                        "type": "ack",
