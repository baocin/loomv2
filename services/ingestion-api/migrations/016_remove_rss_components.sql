...
-- Remove compression and retention policies for RSS table
SELECT remove_compression_policy('external_rss_items_raw', true);
SELECT remove_retention_policy('external_rss_items_raw', true);
