...
class WebConsumer(BaseConsumer):
    ...
    async def _get_chrome_history(self) -> List[BaseMessage]:
        ...
        try:
            ...
            since_chrome_time = int(since_time.timestamp() * 1000000) + 11644473600000000
            ...
            for url, title, visit_time, duration in rows:
                ...
                visit = WebVisit(
                    ...
                    visit_duration=duration // 1000000 if duration else None,  # Convert to seconds
                    browser="chrome",
                )
                visits.append(visit)
            ...
            if os.path.exists(firefox_profile_path):
                ...
                for item in os.listdir(firefox_profile_path):
                    if item.endswith(".default-release"):
                        firefox_path = os.path.join(firefox_profile_path, item, "places.sqlite")
                        break
    ...
    async def _get_mock_web_data(self) -> List[BaseMessage]:
        ...
        sample_sites = [
            ...
            {"url": "https://stackoverflow.com/questions/tagged/python", "title": "Python Questions - Stack Overflow"},
            ...
            {"url": "https://arxiv.org/list/cs.AI/recent", "title": "Recent AI Papers - arXiv"},
            {"url": "https://www.youtube.com/watch?v=dQw4w9WgXcQ", "title": "Interesting Video"},
            {"url": "https://medium.com/@author/machine-learning-article", "title": "ML Article - Medium"},
        ]
        ...
        for i in range(min(num_visits, len(sample_sites))):
            ...
            visit = WebVisit(
                ...
                is_incognito=random.choice([True, False, False, False]),  # 25% incognito
            )
