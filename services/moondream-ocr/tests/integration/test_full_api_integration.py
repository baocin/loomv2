...
def mock_model_loading():
    ...
    with patch("app.main.AutoModelForCausalLM") as mock_model, \
         patch("app.main.AutoTokenizer") as mock_tokenizer, \
         patch("app.main.torch") as mock_torch:
...
class TestFullAPIIntegration:
    ...
    def test_full_ocr_workflow(self, client):
        ...
        assert health_response.status_code in [200, 503]  # May be 503 if model not loaded
