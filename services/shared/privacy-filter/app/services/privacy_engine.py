...
class PrivacyEngine:
    ...
    async def filter_data(
        ...
        for key, value in data.items():
            if isinstance(value, str):
                ...
                if entities:
                    filtered_value = self._replace_entities(
                        value, entities, replacement_strategy
                    )
                ...
                for item in value:
                    if isinstance(item, str):
                        ...
                        if entities:
                            filtered_item = self._replace_entities(
                                item, entities, replacement_strategy
                            )
    ...
    def _replace_entities(
        self, text: str, entities: List[PIIEntity], strategy: ReplacementStrategy
    ) -> str:
