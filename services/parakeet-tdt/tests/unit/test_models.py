...
from app.models import BaseMessage, AudioChunk, TranscribedWord, TranscribedText
...
class TestTranscribedText:
    ...
    def test_transcribed_text_creation(self):
        ...
        words = [
            TranscribedWord(word="hello", start_time=0.0, end_time=0.5, confidence=0.95),
            TranscribedWord(word="world", start_time=0.6, end_time=1.0, confidence=0.90)
        ]
