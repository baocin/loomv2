...
class ExamplePayloads:
    ...
    def device_video_screen_raw() -> Dict[str, Any]:
        ...
        valid_jpeg = base64.b64encode(bytes.fromhex(
    ...
    def device_state_power_raw() -> Dict[str, Any]:
        ...
        return {
            ...
            "metadata": {
                ...
                "time_to_full": random.randint(0, 180) if random.choice([True, False]) else None
            }
        }
    ...
    def external_twitter_liked_raw() -> Dict[str, Any]:
        ...
        return {
            ...
            "data": {
                ...
                "media_urls": [fake.image_url()] if random.choice([True, False]) else []
            },
            "metadata": {
    ...
    def external_twitter_images_raw() -> Dict[str, Any]:
        ...
        valid_png = base64.b64encode(bytes.fromhex(
