...
class TestOriginalConsumerSmoke:
    ...
    @pytest.mark.asyncio
    async def test_process_gps_message(self, mock_db_pool, mock_kafka_consumer, sample_gps_message):
    ...
    @pytest.mark.asyncio
    async def test_process_power_message(self, mock_db_pool, mock_kafka_consumer, sample_power_message):
    ...
    @pytest.mark.asyncio
    async def test_consumer_error_recovery(self, mock_db_pool, mock_kafka_consumer, sample_gps_message):
    ...
    @pytest.mark.asyncio
    async def test_consumer_metrics(self, mock_db_pool, mock_kafka_consumer, sample_gps_message):
        ...
        # Mock metrics
        with patch.object(consumer, 'messages_processed') as mock_processed, \
             patch.object(consumer, 'messages_failed') as mock_failed:
