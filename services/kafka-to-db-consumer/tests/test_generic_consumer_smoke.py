...
class TestGenericConsumerSmoke:
    ...
    @pytest.mark.asyncio
    async def test_consumer_initialization(self, mock_db_pool, mock_kafka_consumer, sample_mapping_config):
    ...
    @pytest.mark.asyncio
    async def test_consumer_start_stop(self, mock_db_pool, mock_kafka_consumer, sample_mapping_config):
    ...
    @pytest.mark.asyncio
    async def test_process_single_gps_message(self, mock_db_pool, mock_kafka_consumer, sample_mapping_config, sample_gps_message):
    ...
    @pytest.mark.asyncio
    async def test_process_multiple_message_types(self, mock_db_pool, mock_kafka_consumer, sample_mapping_config, sample_gps_message, sample_power_message, sample_twitter_message):
        ...
        consumer.mapping_engine.config["topics"].update({
            "device.state.power.raw": {
                ...
                "required_fields": ["trace_id", "device_id", "timestamp", "data.battery_level"]
            },
    ...
    @pytest.mark.asyncio
    async def test_consumer_error_handling(self, mock_db_pool, mock_kafka_consumer, sample_mapping_config):
    ...
    @pytest.mark.asyncio
    async def test_consumer_metrics_increment(self, mock_db_pool, mock_kafka_consumer, sample_mapping_config, sample_gps_message):
        ...
        consumer.messages_processed.labels.assert_called_with(topic="device.sensor.gps.raw")
        consumer.messages_processed.labels().inc.assert_called_once()

    @pytest.mark.asyncio
    async def test_consumer_database_error_recovery(self, mock_db_pool, mock_kafka_consumer, sample_mapping_config, sample_gps_message):
        ...
        consumer.messages_failed.labels.assert_called_with(topic="device.sensor.gps.raw")
