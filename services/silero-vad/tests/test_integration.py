...
class TestKafkaIntegration:
    ...
    async def test_process_valid_message(
        self, kafka_consumer_service, mock_kafka_producer
    ):
    ...
    async def test_process_no_speech_detected(
        self, kafka_consumer_service, mock_kafka_producer
    ):
    ...
    async def test_vad_processor_exception(self, kafka_consumer_service):
        ...
        kafka_consumer_service.vad_processor.process_audio.side_effect = Exception(
            "VAD error"
        )
    ...
    async def test_kafka_producer_error(
        self, kafka_consumer_service, mock_kafka_producer
    ):
