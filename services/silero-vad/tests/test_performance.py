...
class TestPerformance:
    ...
    async def test_throughput(self, vad_processor):
        ...
        num_messages = 100
        chunks = [self.create_audio_chunk(duration_seconds=0.5) for _ in range(num_messages)]
    ...
    async def test_memory_usage(self, vad_processor):
        ...
        for i in range(500):
            ...
            if i % 100 == 0:
                ...
                print(f"After {i} messages: Memory increased by {memory_increase:.2f}MB")
    ...
    async def test_concurrent_processing(self, vad_processor):
        ...
        num_concurrent = 20
        chunks = [self.create_audio_chunk(duration_seconds=1.0) for _ in range(num_concurrent)]
    ...
    async def test_varying_audio_lengths(self, vad_processor):
        ...
        for duration in durations:
            ...
            print(f"Audio duration: {duration}s, Processing time: {processing_time * 1000:.2f}ms")
