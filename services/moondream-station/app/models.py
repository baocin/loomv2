...
class ImageAnalysisRequest(BaseModel):
    ...
    enable_object_detection: Optional[bool] = Field(None, description="Enable object detection")
...
class MoondreamAnalysisResult(BaseMessage):
    ...
    query_response: Optional[str] = Field(None, description="Response to specific query")
...
class MoondreamResponse(BaseModel):
    ...
    objects: Optional[List[Dict[str, Any]]] = Field(None, description="Detected objects")
