...
def create_test_tweet_image():
    ...
    draw.text((20, 50), "This is a test tweet with some text that should be", fill='black')
    draw.text((20, 70), "extracted by the OCR service. Let's see if it works!", fill='black')
