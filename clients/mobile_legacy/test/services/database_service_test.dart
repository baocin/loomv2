...
void main() {
  group('Hertz Modal Tests', () {
    test('Hertz modal should display correct time interval text', () {
    ...
    test('Snap to common frequency function should work correctly', () {
    ...
    test('Decimal precision should adjust based on frequency value', () {
