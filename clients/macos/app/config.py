...
class LoomConfig(BaseSettings):
    ...
    server_host: str = Field(
        default="127.0.0.1",
        env="LOOM_SERVER_HOST",
        description="Local API server host"
    )
    
    server_port: int = Field(
        default=8080,
        env="LOOM_SERVER_PORT",
