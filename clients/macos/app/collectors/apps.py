...
class AppsCollector(BaseCollector):
    ...
    async def _get_app_data(self) -> dict[str, Any]:
        ...
        if active_app != self._last_active_app:
            logger.info(
                "Active app changed", from_app=self._last_active_app, to_app=active_app
            )
    ...
    async def get_status(self) -> dict[str, Any]:
        ...
        base_status.update({"last_active_app": self._last_active_app})
        return base_status
