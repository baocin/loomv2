...
class ClipboardCollector(BaseCollector):
    ...
    async def collect(self) -> bool:
        ...
        try:
            ...
            if success:
                ...
                logger.info(
                    "Clipboard change detected and sent", length=len(clipboard_content)
                )
            else:
                self._error_count += 1
    ...
    async def _get_clipboard_content(self) -> str | None:
    ...
    async def get_status(self) -> dict[str, Any]:
        ...
        base_status.update({"last_clipboard_hash": self._last_clipboard_hash})
        return base_status
