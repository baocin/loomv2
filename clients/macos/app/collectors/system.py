            ...
            try:
                ...
                if battery_info:
                    battery = {
                        ...
                        "seconds_left": battery_info.secsleft if battery_info.secsleft != psutil.POWER_TIME_UNLIMITED else None
                    }
            except:
                pass
    ...
    async def get_status(self) -> Dict[str, Any]:
        ...
        if self._system_info:
            base_status.update({
                ...
                "memory_total_gb": round(self._system_info.get("memory_total", 0) / (1024**3), 2)
            })
        return base_status